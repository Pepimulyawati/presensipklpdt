...
// Meniru persis tanpa WithHeadingRow, menggunakan pembacaan indeks baris manual
class PemberangkatanImport implements ToModel
{
    ...
    public function model(array $row)
    {
        ...
        // Kolom A (0) = Nama DUDI
        // Kolom B (1) = Nama Guru
        // Kolom C (2) = Tanggal Pemberangkatan
        // Kolom D (3) = Status
        ...
        // 5. AMBIL TANGGAL (Bebas karena tipe data database sudah string)
        ...
        // 7. EKSEKUSI UPDATE ATAU CREATE KEDALAM TABEL PEMBERANGKATAN
        return Pemberangkatan::updateOrCreate(
            ['dudi_id' => $dudi->id],
            [
                'guru_id'                => $guruId,
                'tanggal_pemberangkatan' => $tanggal, // Masuk aman sebagai string murni
                'status'                 => $status,
            ]
        );
    }
